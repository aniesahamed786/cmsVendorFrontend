      ...
      .subscribe({
        next: (res: any) => {
          ...
          this.OfferBasicData.set({
            ...
            hotelDetails: res.hotelDetails ?? res.hotel_details ?? null,
            hotel_details: res.hotel_details ?? res.hotelDetails ?? null,
            roomDetails: res.roomDetails ?? res.hotelDetails?.roomDetails ?? res.hotel_details?.roomDetails,
            rooms: res.rooms ?? res.hotelDetails?.rooms ?? res.hotel_details?.rooms,
            hotelAmenitites: res.hotelAmenitites ?? res.hotelAmenities ?? res.hotelDetails?.hotelAmenitites ?? res.hotel_details?.hotelAmenitites,
            hotelAmenitites_ar: res.hotelAmenitites_ar ?? res.hotelAmenities_ar ?? res.hotelDetails?.hotelAmenitites_ar ?? res.hotel_details?.hotelAmenitites_ar,
            hotelAmenities: res.hotelAmenities ?? res.hotelAmenitites ?? res.hotelDetails?.hotelAmenities ?? res.hotel_details?.hotelAmenities,
            hotelAmenities_ar: res.hotelAmenities_ar ?? res.hotelAmenitites_ar ?? res.hotelDetails?.hotelAmenities_ar ?? res.hotel_details?.hotelAmenities_ar,
            taxValue: res.taxValue ?? res.hotelDetails?.taxValue ?? res.hotel_details?.taxValue,
            taxValue_ar: res.taxValue_ar ?? res.hotelDetails?.taxValue_ar ?? res.hotel_details?.taxValue_ar,
            currency: res.currency ?? res.hotelDetails?.currency ?? res.hotel_details?.currency ?? 'SAR',
            currency_ar: res.currency_ar ?? res.hotelDetails?.currency_ar ?? res.hotel_details?.currency_ar ?? 'SAR',
